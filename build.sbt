...
name := "udash-bootstrap4-demo"

inThisBuild(Seq(
  version := "0.1.0-SNAPSHOT",
  scalaVersion := Dependencies.versionOfScala,
  organization := "eu.iums.bootstrap4",
  scalacOptions ++= Seq(
    "-feature",
    "-deprecation",
    "-unchecked",
...
val commonSettings = Seq(
  moduleName := "udash-bootstrap4-demo-" + moduleName.value,
)
...
lazy val root = project.in(file("."))
  ...
  .settings(
    ...
    Compile / mainClass := Some("eu.iums.bootstrap4.backend.Launcher")
  )
...
lazy val frontend = project.in(file("frontend"))
  ...
  .settings(
    ...
    Compile / mainClass := Some("eu.iums.bootstrap4.frontend.JSLauncher"),
    ...
    compileCss := Def.taskDyn {
      ...
      dir.mkdirs()
      (backend / Compile / runMain).toTask(s" eu.iums.bootstrap4.backend.css.CssRenderer $path false")
    }.value,
...
lazy val packager = project
  ...
  .settings(commonSettings)
  .settings(
    normalizedName := "udash-bootstrap4-demo",
