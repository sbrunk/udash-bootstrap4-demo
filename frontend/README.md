...
* `eu.iums.bootstrap4.frontend.routing` - all the code related to the frontend application routing.
* `eu.iums.bootstrap4.frontend.services` - the business logic of the client application.
* `eu.iums.bootstrap4.frontend.views` - the code describing views and their behaviour.

The root package (`eu.iums.bootstrap4.frontend`) also contains `JSLauncher` and `ApplicationContext`. The former 
